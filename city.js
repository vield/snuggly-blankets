// Some sample cities with different climates, shown in the dropdown for an easy demo

// In the future, there will be a way for the user to input their own temperatures
// - in Celsius or Fahrenheit (specified at input time, only matters if the user
//   wants working conversions, a number is a number)
// - for as many days as they want (although this affects the blanket size and
//   you might need a specific number of days if making a hexagon/square/etc
//   blanket)
